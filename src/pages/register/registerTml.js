    ...
    <section class="form-wrapper">
        ...
        <form>
            <div class="inputs">
                ...
                {{> input/input id="repeat-password" name="password-repeat" label="Repeat password" type="password" placeholder="1234"}}
            </div>

            {{> button/button id="create-account" caption="Create account" class="button--green"}}
        </form>
